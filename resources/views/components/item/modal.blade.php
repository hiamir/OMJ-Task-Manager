@props(['type','buttonName'=>'Give some name', 'modalHeader'=>'Give a header'])
<x-item.button @click.prevent="isFirstModelButtonClicked = true" size="small">
    @switch($type)
        @case('add')
...
>
    <div
        class=" opacity-0 sm:max-w-lg sm:w-full m-3 sm:mx-auto h-[calc(100%-3.5rem)] min-h-[calc(100%-3.5rem)] flex items-center"
        :class="{ '!flex transition-all duration-300 opacity-100 ': isFirstModelButtonClicked===true }"
    >
        <div
            class="max-h-full overflow-hidden flex flex-col bg-white border shadow-sm rounded-xl dark:bg-oblue-300 dark:border-oblue-100 dark:shadow-olblue-900/[.5]">
            <div class="flex justify-between items-center py-3 px-4 border-b dark:border-olblue-800">
                ...
                <button @click.prevent="isFirstModelButtonClicked = false" type="button"
                ...
                <div class="space-y-4">
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-gray-800 dark:text-gray-400">
                            ...
                            that they can jump in and start working expecting to find a dependable experience across all
                            the things. Keep teams in the loop about what is happening by informing them of relevant
                            features, products and opportunities for success. Be on the journey with them and highlight
                    ...
                    <div>
                        ...
                        <p class="mt-1 text-gray-800 dark:text-gray-400">
                            ...
                            same time realize that novbody likes a nosy neighbor. Give the user just enough to know that
                            something awesome is around the corner and then get out of the way. Write clear, accurate,
                            and concise text that makes interfaces more usable and consistent - and builds trust. We
                            strive to write text that is understandable by anyone, anywhere, regardless of their culture
