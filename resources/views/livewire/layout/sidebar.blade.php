...
{{--        </button>--}}
        ...
        <nav class="hs-accordion-group p-6 w-full flex flex-col flex-wrap" data-hs-accordion-always-open>
            <ul class="space-y-1.5">
                <li>
                    <a class="flex items-center gap-x-3.5 py-2 px-2.5 bg-slate-100 text-sm text-slate-700 rounded-md hover:bg-slate-100 dark:bg-oblue-600 dark:text-white"
                       href="javascript:;">
                ...
                <li class="hs-accordion" id="users-accordion">
                    <a class="hs-accordion-toggle flex items-center gap-x-3.5 py-2 px-2.5 hs-accordion-active:text-blue-600 hs-accordion-active:hover:bg-transparent text-sm text-slate-700 rounded-md hover:bg-slate-100  dark:hover:bg-oblue-500 dark:text-slate-400 dark:hover:bg-oblue-500 dark:hs-accordion-active:text-white"
                       href="javascript:;">
                        ...
                        <svg
                            class="hs-accordion-active:block ml-auto hidden w-3 h-3 text-slate-600 group-hover:text-slate-500 dark:text-slate-400"
                        ...
                        <svg
                            class="hs-accordion-active:hidden ml-auto block w-3 h-3 text-slate-600 group-hover:text-slate-500 dark:text-slate-400"
                            width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
