            ...
            <x-item.form method="POST">
                @if($formType === 'create' || $formType === 'update')
                    <div class="grid grid-cols-1 gap-4">
                        ...
                        <x-item.elements.select wireName="menu.guards_id" name="menu-guards_id" label="Guard"
                                                :data=$guards
                        ...
                        <x-item.elements.select wireName="menu.parent_id" name="menu-parent_id" label="Belongs to"
                                                :data=$parentData
                                                placeholder=""></x-item.elements.select>
                    </div>
                @endif
                        ...
                        <div
                            ...
                            <div class="flex items-center">
                                ...
                                <div wire:click="show('delete',{{$menu}})"
                                    ...
                                    <x-svg.close
                                        class=" !w-3 !h-3 dark:text-olblue-300 dark:group-hover:text-white "></x-svg.close>
                                </div>
                                    ...
                                    <li class="dark:text-gray-300 my-2">
                                        <div
                                            ...
                                            <div wire:click.prevent="show('create',{{$childMenu1}})"
                                                ...
                                                <x-svg.add
                                                    class=" flex !w-3 !h-3 dark:text-olblue-300 dark:group-hover:text-white "></x-svg.add>
                                            </div>
                                            <span wire:click.prevent="show('update',{{$childMenu1}},'l1')"
                                                  class="transition-all duration-300 cursor-pointer mx-2 dark:hover:text-white dark:text-blue-100 text-gray-700  hover:text-gray-900 flex h-6 justify-center items-center"> {{$childMenu1->name}} </span>
                                            <div wire:click="show('delete',{{$childMenu1}})"
                                                ...
                                                <x-svg.close
                                                    class=" !w-2 !h-2 dark:text-olblue-300 dark:group-hover:text-white "></x-svg.close>
                                            </div>
                                        </div>
                                    </li>
                                    <ul class="ml-5">
                                        @foreach($childMenu1->childMenus as $childMenu2)
                                            <li class="dark:text-gray-300 my-2">
                                                <div
                                                    class="inline-flex flex-row capitalize text-sm items-center px-2 py-1 rounded-md border dark:border-olblue-800/[0.5]">
                                                    <div
                                                    ...
                                                    <span wire:click.prevent="show('update',{{$childMenu2}},'l2')"
                                                          class="transition-all duration-300 cursor-pointer dark:hover:text-blue-500 mx-2 flex h-6 justify-center items-center"> {{$childMenu2->name}} </span>
