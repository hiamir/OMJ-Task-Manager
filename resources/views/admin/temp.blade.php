<x-app-layout>
    ...
    <div id="hs-static-backdrop-modal" class="hs-overlay hidden w-full h-full fixed top-0 left-0 z-[60] overflow-x-hidden overflow-y-auto" data-hs-overlay-keyboard="false" data-hs-overlay-backdrop="static">
